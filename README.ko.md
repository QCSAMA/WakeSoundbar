...
WakeSoundbar는 사운드바 또는 AV 리시버를 **바탕 화면에서 디스플레이 제거**로
설정한 Windows 11 환경에서 로그인 후 HDMI 오디오를 복원하는 가벼운 유틸리티입니다.
제거된 HDMI 디스플레이 경로를 깨워 오디오 장치가 다시 나타나게 하며, 메인 화면의
4K, HDR, 높은 주사율, VRR 설정을 바꾸거나 백그라운드 프로세스를 계속 실행하지 않습니다.

**적합한 경우**

- 게임용 PC 또는 HTPC
- HDMI로 연결한 사운드바 또는 AV 리시버
- 재부팅 후 HDMI 오디오가 사라지는 시스템

**적합하지 않은 경우**

- Bluetooth, USB 또는 S/PDIF 오디오
- **바탕 화면에서 디스플레이 제거**를 사용하지 않는 구성
